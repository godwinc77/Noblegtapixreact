...
const PortfolioBackground = () => {
  const baseURL = "http://localhost:4000/portfolio-background-images/";
  ...
  const submitImage = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:4000/portfolio-background-upoad-image",
        formData,
        {
  ...
  const getImage = async () => {
    try {
      ...
      const response = await axios.get(
        "http://localhost:4000/portfolio-background-get-image"
      );
